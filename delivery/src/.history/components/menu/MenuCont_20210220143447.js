      ...
      <div id="menu">
        ...
        <div id="menuInnerCont">
          <div className="menuChoice">
            <h3 className="choiceTitle">Margarita Pizza</h3>
            <div className="choiceBtnCont">
              <button className="choiceBtn addBtn">1 </button>
              <button className="choiceBtn viewBtn">1 </button>
            </div>
            <div className="choiceInfo">
              <p>Yummy Roma tomatoes stacked on top of a warm flaky crust</p>
            </div>
          </div>
        </div>
      </div>
